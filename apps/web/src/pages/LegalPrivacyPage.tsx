          ...
          <Card className="border border-border bg-card rounded-2xl shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
            <CardContent className="p-6 md:p-8 space-y-5 text-sm text-muted-foreground">
              <div className="flex items-center gap-3 pb-4 border-b border-border">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    RH&MOI by SUP des RH &middot; Lamascott
                  </p>
                </div>
              </div>
              ...
              <p>
                ...
                collectées lorsque tu utilises l&apos;outil d&apos;orientation RH&MOI by SUP des RH
              ...
              {[
                ...
                },
                {
                  ...
                  content:
                    "Les données collectées via l'outil RH&MOI by SUP des RH sont utilisées uniquement par Sup des RH et ses prestataires techniques pour le fonctionnement du service. Elles ne sont ni revendues, ni utilisées à des fins publicitaires pour des tiers.",
                },
                {
                  title: "6. Tes droits",
                  content:
